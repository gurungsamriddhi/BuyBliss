        ...
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                ...
                @forelse ($products as $product)
                    <!--click image-->
                    <a href="{{ route('product.show', $product->id) }}" class="group transform transition duration-200 hover:scale-105 hover:shadow-lg">
                        <div
                            class="aspect-square w-full rounded-lg bg-gray-200 flex items-center justify-center overflow-hidden">
